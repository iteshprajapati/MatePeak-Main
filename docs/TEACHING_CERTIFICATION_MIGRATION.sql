-- =====================================================
-- Teaching Certification Feature Migration
-- =====================================================
...
-- Uncomment the following lines to verify after running the migration:
-- SELECT column_name, data_type, column_default 
-- FROM information_schema.columns 
-- WHERE table_name = 'expert_profiles' 
-- AND column_name IN ('teaching_certifications', 'has_no_certificate', 'introduction', 'teaching_experience', 'motivation', 'headline', 'education');

-- SELECT * FROM storage.buckets WHERE id = 'teaching-certificates';
