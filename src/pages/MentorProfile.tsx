      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-grow flex items-center justify-center flex-col p-8">
          ...
          <p className="text-gray-600 mb-6">
            The mentor you're looking for doesn't exist or may have been
            removed.
          </p>
          <Link to="/mentors">
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {mentor.categories.map((category, index) => (
                    <Badge
                      key={index}
                      variant="outline"
                      className="bg-mentor-light text-mentor-primary border-mentor-light"
                    >
                      {category}
                    </Badge>
                  ))}
              ...
              <div className="flex flex-col gap-3 w-full md:w-auto">
                ...
                <Button
                  variant="outline"
                  className="w-full border-mentor-primary text-mentor-primary"
                >
            ...
            <TabsContent value="about" className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mt-4">
                  I believe in a personalized approach to mentoring, focusing on
                  each student's unique needs and learning style. My goal is to
                  not just help you with immediate problems, but to equip you
                  with the skills and knowledge to succeed in the long term.
                </p>
              </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-l-2 border-gray-200 pl-4 ml-2">
                    ...
                    <p className="text-gray-600">
                      Master's Degree, Top University
                    </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Recognized for outstanding mentorship
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="border-b border-gray-100 pb-6">
                    ...
                    <p className="text-gray-600">
                      The session was extremely helpful! {mentor.name} explained
                      complex concepts in a way that was easy to understand, and
                      provided practical advice I could implement right away.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-gray-100 pb-6">
                    ...
                    <p className="text-gray-600">
                      I've had multiple sessions with {mentor.name} and each one
                      has been valuable. The personalized approach and follow-up
                      materials have really helped me improve.
                    </p>
                  </div>
                  ...
                  <div className="border-b border-gray-100 pb-6">
                    ...
                    <p className="text-gray-600">
                      Thanks to {mentor.name}'s guidance, I was able to ace my
                      interview and secure a job offer! The mock interview
                      sessions were incredibly realistic and the feedback was
                      invaluable.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm mt-1">
                          Brief 30-minute sessions for specific questions or
                          quick advice.
                        </p>
                        <div className="mt-3 flex items-baseline gap-2">
                          <span className="text-sm font-semibold text-gray-400 line-through">
                            ₹{Math.round(mentor.price / 2)}
                          </span>
                          <span className="text-2xl font-bold text-green-600">
                            ₹0
                          </span>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Fill out a brief form to help your mentor prepare for
                        your specific needs.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Connect via our secure video platform for your scheduled
                        session.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Receive personalized resources and action items after
                        your session.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        If you're not satisfied with your session, we offer a
                        full refund.
                      </p>
                    </div>
                  </div>
