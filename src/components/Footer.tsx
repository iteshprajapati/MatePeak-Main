        ...
        <div className="container mx-auto px-8 md:px-12 lg:px-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link to="/explore" className="text-gray-600 hover:text-matepeak-primary transition-colors duration-300">
                    Browse Mentors
                  </Link>
                </li>
                <li>
                  <Link to="/expert-signup" className="text-gray-600 hover:text-matepeak-primary transition-colors duration-300">
                    Become a Mentor
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link to="/about" className="text-gray-600 hover:text-matepeak-primary transition-colors duration-300">
                    About Us
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <Link to="/privacy" className="text-gray-600 hover:text-matepeak-primary transition-colors duration-300">
                    Privacy Policy
                  </Link>
                </li>
                <li>
          ...
          <div className="pt-10 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-5">
              <a href="#" className="text-gray-400 hover:text-matepeak-primary transition-colors duration-300 hover:scale-110 transform">
