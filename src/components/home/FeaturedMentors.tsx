    ...
    <section className="py-20 md:py-28 bg-gray-50" ref={sectionRef}>
      <div className="w-full max-w-6xl mx-auto px-4 md:px-8 xl:px-0">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4 text-matepeak-primary">
            Our Mentors
          </h2>
              ...
              {categoryMentors.length > 0 ? (
                <>
                  ...
                  <div className="text-center mt-6">
                    <Link
                      to={`/mentors?category=${encodeURIComponent(category)}`}
                    >
                      <Button
                        variant="outline"
                        className="border-matepeak-primary text-matepeak-primary hover:bg-gray-100"
                      >
