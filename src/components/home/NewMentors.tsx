...
const NewMentors = ({ sectionRef }: NewMentorsProps) => {
  ...
  if (!loading && newMentors.length === 0) {
    return (
      <section className="py-16 bg-gradient-to-br from-matepeak-yellow/10 via-white to-matepeak-primary/5" ref={sectionRef}>
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-matepeak-primary/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-matepeak-primary">Just Joined</span>
            </div>
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Welcome our newest mentors to the platform! Connect with fresh perspectives and expertise.
            </p>
            <p className="text-gray-500">Be the first to connect with mentors as they join!</p>
          </div>
        </div>
      </section>
    );
