...
export default function StudentReviews({ studentProfile }: StudentReviewsProps) {
  ...
  const fetchReviews = async () => {
    try {
      ...
      const pending = completedSessions?.filter(s => !reviewedBookingIds.has(s.id)) || [];
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div 
                      ...
                      onClick={() => navigate(`/mentor/${review.expert_profiles?.username}`)}
                    >
                    ...
                    <div className="flex-1">
                      ...
                      {review.bookings && (
                        <div className="mt-3 text-sm text-gray-500">
                          Session: {new Date(review.bookings.session_date).toLocaleDateString()} 
                          {' • '}
